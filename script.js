...
let fulllistItem = `<span class="btn-icons">
...
function saveEditHandler(e) {
  ...
  console.log(editedTodo.firstElementChild);
...
form.addEventListener("click", function (e) {
  ...
  if (e.target && e.target.id === "add-todo-btn") {
    addBtn.addEventListener("click", addTodoHandler(e));
  }
...
console.log(document.querySelector(".edit-todo-btn"));
